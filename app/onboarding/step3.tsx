      ...
      <View style={styles.inner}>
        <View style={styles.progressRow}>
          {QUESTIONS.map((_, i) => (
            <View
              key={i}
              style={[styles.progressDot, { backgroundColor: i <= step ? '#7F77DD' : '#2E2E2C' }]}
            />
          ))}
        </View>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            ...
            router.push(
              `/onboarding/step4?a0=${params.a0}&a1=${params.a1}&a2=${params.a2}&a3=${encodeURIComponent(answer)}`
            );
          }}
...
const styles = StyleSheet.create({
  ...
  input: {
    ...
    fontSize: 16, color: '#F0F0EE', minHeight: 120,
    textAlignVertical: 'top', borderWidth: 0.5, borderColor: '#2E2E2C',
  },
