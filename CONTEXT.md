...
- [x] Build Android funcional — APK: https://expo.dev/accounts/pulse-app73/projects/pulse-mobile/builds/5bcd8bed-1200-4157-b824-3d3a5769d55d
- [x] **App instalada y arrancando en Samsung Galaxy A32 5G** — muestra pantalla "Pulse"
- [x] Estructura de carpetas creada: app/, app/(auth)/, app/(app)/, app/(onboarding)/
- [x] Ficheros base: app/_layout.tsx y app/index.tsx funcionando
- [ ] Añadir pantallas completas de Pulse (home, chat, contacts, capsule, profile)
- [ ] Añadir autenticación con Supabase
